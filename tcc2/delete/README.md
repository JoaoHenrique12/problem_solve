...
```
root@39e02478b963:/app# pkcs11-tool --module /usr/local/lib/softhsm/libsofthsm2.so   --login --pin 0000   --sign   --id 02   --list-mechanism
Using slot 0 with a present token (0x3220934b)
